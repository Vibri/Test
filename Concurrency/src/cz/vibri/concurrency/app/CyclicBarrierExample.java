...
class CyclicBarrierWorker implements Runnable {
    ...
    private void doWork() {
        System.out.println(Thread.currentThread().getName() +  " Thread with ID " + this.id + " starts the work...");
        try {
        ...
        System.out.println(Thread.currentThread().getName() +  " After the await");
    }
}
...
public class CyclicBarrierExample {
    public static void main(String[] args) {
        ...
        CyclicBarrier barrier = new CyclicBarrier(5, new Runnable() {
            @Override
            public void run() {
                System.out.println(Thread.currentThread().getName() + " All tasks have been finished...");
            }
        });
