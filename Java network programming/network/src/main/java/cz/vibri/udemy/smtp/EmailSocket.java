...
public class EmailSocket {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(smtpSocket.getLocalAddress().getHostAddress());
		...
		if (smtpSocket != null && out != null && in != null) {
			try {
				...
				out.println("RCPT TO: mikulasek.viktor.cz@gmail.com");
				...
				out.println("To: mikulasek.viktor.cz@gmail.com");
